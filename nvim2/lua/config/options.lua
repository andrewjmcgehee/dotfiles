-- TODO: most of these can be removed with hardcoding in other areas. revisit this
...
-- opt.statuscolumn = [[%!v:lua.require'snacks.statuscolumn'.get()]] --TODO: re-enable after snacks installed
